...
#[export] Hint Rewrite Z.leb_gt: libInts.
#[export] Hint Rewrite Z.leb_le: libInts.
#[export] Hint Rewrite Z.geb_leb: libInts.
#[export] Hint Rewrite <- Zgt_is_gt_bool: libInts.
#[export] Hint Rewrite Z.geb_le: libInts.
#[export] Hint Rewrite Z.ltb_lt: libInts.
#[export] Hint Rewrite Z.ltb_ge: libInts.
#[export] Hint Rewrite <- Zeq_is_eq_bool: libInts.
(*
...
#[export] Hint Rewrite Zeq_bool_neq2: libInts.
#[export] Hint Rewrite Zeq_bool_neq3: libInts.
