// TODO: Move this to integration tests (has a dependency on the scalac frontend)
...
//    }
//
//    val allOpts = Build.libraryFiles ++ files ++ compilerOpts
//    frontends.scalac.ScalaCompiler(ctx, allOpts.toList)
//  }
//}
