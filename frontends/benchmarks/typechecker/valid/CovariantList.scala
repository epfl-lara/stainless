...
object CovariantList {
  // TYPEFIX: Type encoding creates an ADT which is mutually recursive with a function
  ...
  //   def contains[T1 >: T](v: T1): Boolean = {
  //     decreases(this)
  //     this match {
  ...
  //   def indexOf[T1 >: T](elem: T1): BigInt = {
  //     decreases(this)
  //       this match {
  //       case Nil => BigInt(-1)
  ...
  //   def splitAt(index: BigInt): (List[T], List[T]) = {
  //     decreases(this)
  //     this match {
  //       case Nil => (Nil, Nil)
  //       case h :: rest => {
