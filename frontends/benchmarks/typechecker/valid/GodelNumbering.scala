...
object GodelNumbering {
  ...
  @induct
  def associative_plus(n1: Nat, n2: Nat, n3: Nat): Unit = {
    ()
    ...
    n1 match {
      ...
      case Succ(p1) => n2 match {
        case Zero =>
          ...
          plus_zero(p1)
        case Succ(p2) =>
          commutative_plus(n1, p2)
          commutative_plus(p1, n2)
      }
    }
  ...
  @opaque
  def plus_succ(n1: Nat, n2: Nat): Unit = {
    (
