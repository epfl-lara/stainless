/**
  ...
  * Taken from https://gist.github.com/jad-hamza/62ac1947b28ff05113463b861073f4b8#file-berardi-scala
  *
  *
  * References:
...
object Berardi1 {
  ...
  def russel() = {
    ...
    val j2: Pow[U] => Pow[U] = l.j2 // "Quantification does not fit in supported fragment"
