...
To build the projet, run `sbt universal:stage`. If all goes well, a binary gets generated: `frontends/scalac/target/universal/stage/bin/stainless-scalac`. More information is available in the documentation links.
