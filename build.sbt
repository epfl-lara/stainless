...
// lazy val inox = ghProject("https://github.com/epfl-lara/inox.git", "0ef0ce3d642213dc60647f0cbf9ea91ccf905b61")
lazy val inox = RootProject(uri("https://github.com/epfl-lara/inox.git"))
